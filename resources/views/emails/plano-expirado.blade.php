...
<body style="font-family: Arial, sans-serif; background-color: #f4f4f4; margin: 0; padding: 20px;">
    <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 8px; overflow: hidden;">
        ...
        <div style="padding: 30px;">
            ...
            <p>O seu plano <strong>{{ $assinatura->plano->nome }}</strong> expirou em <strong>{{ $assinatura->data_expiracao->format('d/m/Y') }}</strong>.</p>
            ...
            <div style="text-align: center; margin: 25px 0;">
                <a href="{{ route('painel.ativar-plano') }}" style="display:inline-block;background:#e74c3c;color:#fff;padding:12px 30px;border-radius:6px;text-decoration:none;font-weight:bold;">Ativar Novo Plano</a>
            </div>
        </div>
