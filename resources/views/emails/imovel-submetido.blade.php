...
<body style="font-family: Arial, sans-serif; background-color: #f4f4f4; margin: 0; padding: 20px;">
    <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 8px; overflow: hidden;">
        ...
        <div style="padding: 30px;">
            ...
            <p>Um novo imóvel foi submetido pela imobiliária <strong>{{ $imovel->imobiliaria->nome }}</strong> e aguarda revisão.</p>
            ...
            <table style="width: 100%; border-collapse: collapse; margin: 20px 0;">
                ...
                <tr>
                    ...
                    <td style="padding: 10px; border-bottom: 1px solid #eee;">{{ $imovel->finalidade }}</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td style="padding: 10px; border-bottom: 1px solid #eee;">{{ $imovel->bairro }}, {{ $imovel->municipio }}, {{ $imovel->provincia }}</td>
                </tr>
            </table>
