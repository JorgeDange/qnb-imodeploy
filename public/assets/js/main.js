document.addEventListener("DOMContentLoaded", (event) => {
    ...
    if (preloader) {
        ...
        const MIN_VISIVEL = 500;
        function esconderPreloader() {
            const restante = MIN_VISIVEL - (Date.now() - inicio);
            setTimeout(function () {
    ...
    window.ULSwipers = window.ULSwipers || {};

    // project details img slider
    var ulProjectDetailsImgSlider = window.ULSwipers.detailsThumbs = new Swiper(".ul-project-details-img-slider-thumb", {
        spaceBetween: 24,
        slidesPerView: 4,
        freeMode: true,
    ...
    window.ULSwipers.detailsMain = new Swiper(".ul-project-details-img-slider", {
        autoplay: true,
        loop: true,
        thumbs: {
    ...
    window.ULSwipers.featured = new Swiper(".ul-featured-properties-slider", {
        slidesPerView: 4,
        loop: true,
        autoplay: true,
        navigation: {
    ...
    // sidebar slider
    window.ULSwipers.sidebar = new Swiper(".ul-sidebar-slider", {
        slidesPerView: 1.8,
        spaceBetween: 30,
        loop: true,
        autoplay: true,
