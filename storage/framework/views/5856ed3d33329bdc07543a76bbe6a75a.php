...
<body style="font-family: Arial, sans-serif; background-color: #f4f4f4; margin: 0; padding: 20px;">
    <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 8px; overflow: hidden;">
        <div style="background-color: <?php echo e($estado === 'aprovado' ? '#27ae60' : '#c0392b'); ?>; color: #ffffff; padding: 20px; text-align: center;">
            ...
            <table style="width: 100%; border-collapse: collapse; margin: 20px 0;">
                ...
                <tr>
                    ...
                    <td style="padding: 10px; border-bottom: 1px solid #eee;">
                        <span style="color: <?php echo e($estado === 'aprovado' ? '#27ae60' : '#c0392b'); ?>; font-weight: bold;">
...
<?php /**PATH C:\Users\JORGE DANGE\Documents\PROGRAMACAO\WEB\QND\PageWeb\imobiliaria\qnb-imobiliaria\resources\views\emails\imovel-aprovado.blade.php ENDPATH**/ ?>