<?php $__env->startSection('title', 'QNB-Imobiliária - Sobre a QNB'); ?>
<?php $__env->startSection('pagina', 'about'); ?>
    ...
    <section class="ul-about ul-inner-about ul-section-spacing">
        <div class="ul-inner-page-container my-0 wow animate__fadeInUp">
            <div class="row row-cols-lg-2 row-cols-1 align-items-center ul-bs-row">
                        ...
                        <div class="ul-about-txt-bottom ul-inner-about-txt-bottom">
                            ...
                            <div class="ul-about-stats ul-inner-about-stats">
                                <div class="ul-about-stat ul-inner-about-stat">
                                    <span class="number"><?php echo e($estatisticas['imobiliarias'] ?? 50); ?>+</span>
                                    <span class="txt">Clientes Satisfeitos</span>
                                </div>
                                <div class="ul-about-stat ul-inner-about-stat">
                                    <span class="number"><?php echo e($estatisticas['imoveis'] ?? 100); ?>+</span>
                ...
                <!-- img -->
                <div class="col">
                    <div class="ul-about-img ul-inner-about-img"><img src="<?php echo e(asset('assets/img/about-img.jpg')); ?>" alt="About Image"></div>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <div class="ul-inner-testimony">
                            ...
                            <p class="ul-inner-testimony-descr"><?php echo e($depoimento->texto); ?></p>
                            <div class="ul-inner-testimony-bottom">
                                <div class="ul-inner-testimony-reviewer">
                                    <div class="reviewer-image"><img src="<?php echo e($depoimento->avatar ? asset('storage/' . $depoimento->avatar) : asset('assets/img/logo-w.svg')); ?>" alt="reviewer image"></div>
                                    <div>
                                        <h3 class="reviewer-name"><?php echo e($depoimento->nome); ?></h3>
                                        <span class="reviewer-role"><?php echo e($depoimento->cargo); ?></span>
                                    </div>
                                </div>
                    ...
                    <div class="swiper-slide">
                        <div class="ul-inner-testimony">
                            ...
                            <div class="ul-inner-testimony-bottom">
                                <div class="ul-inner-testimony-reviewer">
                                    <div class="reviewer-image"><img src="<?php echo e(asset('assets/img/logo-w.svg')); ?>" alt="reviewer image"></div>
                                    <div>
                    ...
                    <div class="col-lg-3">
                        <div class="ul-section-heading ul-features-heading">
                            <div>
                                ...
                                <a href="<?php echo e(route('imoveis.index')); ?>" class="ul-features-heading-btn ul-btn">Adicionar Imóveis</a>
                            </div>

                            <!-- vector -->
                            <img src="<?php echo e(asset('assets/img/features-vector.svg')); ?>" alt="vector" class="vector wow animate__fadeInLeft">
                        </div>
                    </div>
                            ...
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <div class="ul-feature">
                                        ...
                                        <div class="ul-feature-txt">
                                            <h3 class="ul-feature-title"><a href="<?php echo e(route('imoveis.index')); ?>">Armazéns</a></h3>
                                ...
                                <div class="swiper-slide">
                                    <div class="ul-feature">
                                        ...
                                        <div class="ul-feature-txt">
                                            <h3 class="ul-feature-title"><a href="<?php echo e(route('imoveis.index')); ?>">Condomínios</a></h3>
                                ...
                                <div class="swiper-slide">
                                    <div class="ul-feature">
                                        ...
                                        <div class="ul-feature-txt">
                                            <h3 class="ul-feature-title"><a href="<?php echo e(route('imoveis.index')); ?>">Moradias</a></h3>
...
<?php echo $__env->make('layouts.site', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\JORGE DANGE\Documents\PROGRAMACAO\WEB\QND\PageWeb\imobiliaria\qnb-imobiliaria\resources\views\sobre.blade.php ENDPATH**/ ?>