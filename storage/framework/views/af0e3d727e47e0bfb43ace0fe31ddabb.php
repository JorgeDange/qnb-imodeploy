...
<body style="font-family: Arial, sans-serif; background-color: #f4f4f4; margin: 0; padding: 20px;">
    <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 8px; overflow: hidden;">
        ...
        <div style="padding: 30px;">
            ...
            <p>O seu plano <strong><?php echo e($assinatura->plano->nome); ?></strong> expira em <strong><?php echo e($assinatura->data_expiracao->format('d/m/Y')); ?></strong>.</p>
            <p>Faltam apenas <strong><?php echo e((int) $assinatura->data_expiracao->diffInDays(now())); ?> dia(s)</strong> para a expiração.</p>
            ...
            <div style="text-align: center; margin: 25px 0;">
                <a href="<?php echo e(route('painel.ativar-plano')); ?>" style="display:inline-block;background:#1a5276;color:#fff;padding:12px 30px;border-radius:6px;text-decoration:none;font-weight:bold;">Renovar Plano</a>
            </div>
        </div>
...
<?php /**PATH C:\Users\JORGE DANGE\Documents\PROGRAMACAO\WEB\QND\PageWeb\imobiliaria\qnb-imobiliaria\resources\views\emails\plano-a-expirar.blade.php ENDPATH**/ ?>