<?php $__env->startSection('title', 'QNB-Imobiliária - Encontre o seu imóvel'); ?>
<?php $__env->startSection('pagina', 'index'); ?>
                            ...
                            <div class="row align-items-center flex-sm-row flex-column-reverse">
                                ...
                                <div class="col-md-9 col-sm-8">
                                    ...
                                    <div class="ul-banner-slide-txt wow animate__fadeInUp">
                                        ...
                                        <div class="ul-banner-slide-btns">
                                            <a href="<?php echo e(route('imoveis.index')); ?>" class="ul-btn">Explorar Imóveis</a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3 col-sm-4">
                                    <div class="ul-banner-slide-img wow animate__fadeInUp">
                                        <img src="<?php echo e(asset('assets/img/banner-img-1.png')); ?>" alt="Banner Image">
...
<section class="ul-cities ul-section-spacing">
    <div class="ul-container wow animate__fadeInUp">
        ...
        <div class="ul-section-heading">
            ...
            <div class="right">
                <a href="<?php echo e(route('imoveis.index')); ?>" class="ul-btn">Ver Todos os Imóveis</a>
            </div>
        </div>
        ...
        <div class="row row-cols-xl-4 row-cols-md-3 row-cols-2 row-cols-xxs-1 g-4 mx-auto">
            ...
            <div class="col">
                <div class="ul-city">
                    <div class="img"><a href="<?php echo e(route('imoveis.index', ['provincia' => $cidade->provincia])); ?>"><img src="<?php echo e(asset('assets/img/city-' . $loop->iteration . '.jpg')); ?>" alt="City Image"></a></div>
                    <div class="txt">
                        <h3 class="ul-city-title"><a href="<?php echo e(route('imoveis.index', ['provincia' => $cidade->provincia])); ?>"><?php echo e($cidade->provincia); ?></a></h3>
                        <span class="ul-city-count"><?php echo e($cidade->total); ?> Imóveis</span>
                    </div>
                </div>
            </div>
    ...
    <div class="ul-cities-vectors">
        <img src="<?php echo e(asset('assets/img/cities-vector-1.svg')); ?>" alt="vector" class="vector-1 wow animate__fadeInLeft">
        <img src="<?php echo e(asset('assets/img/cities-vector-1.svg')); ?>" alt="vector" class="vector-2 wow animate__fadeInUp">
    </div>
</section>
<!-- CITIES SECTION END -->
        ...
        <div class="row row-cols-lg-2 row-cols-1 align-items-center">
            <div class="col">
                <div class="ul-why-choose-us-imgs">
                    <div class="img"><img src="<?php echo e(asset('assets/img/why-choose-img-1.jpg')); ?>" alt="image"></div>
                    <div class="img">
                        <img src="<?php echo e(asset('assets/img/why-choose-img-2.jpg')); ?>" alt="image">
                        <!-- icon -->
...
<section class="ul-property-filter-search ul-section-spacing pt-0">
    <div class="ul-property-filter-search-container">
        ...
        <form action="<?php echo e(route('imoveis.index')); ?>" method="GET" class="ul-property-filter-search-form wow animate__fadeInUp">
...
<section class="ul-featured-properties ul-section-spacing">
    ...
    <div class="ul-featured-properties-slider-wrapper wow animate__fadeInUp">
        <div class="ul-featured-properties-slider swiper">
            <div class="swiper-wrapper">
                <?php $__currentLoopData = $imoveisDestaque; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $imovel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <!-- single property slider item -->
                <div class="swiper-slide">
                    <div class="ul-featured-property ul-project">
                        <div>
                            <div class="header">
                                <div class="left"><span class="index"><?php echo e($loop->iteration < 10 ? '0' . $loop->iteration : $loop->iteration); ?></span></div>
                                <div class="right">
...
<section class="ul-facilities ul-section-spacing">
    <div class="ul-container">
        <div class="row ul-bs-row row-cols-lg-2 row-cols-1 wow animate__fadeInUp">
                ...
                <div class="ul-facilities-txt">
                    ...
                    <div class="ul-facilities-img-slider-wrapper">
                        ...
                        <div class="ul-facilities-img-slider swiper">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide"><img src="<?php echo e(asset('assets/img/project-1.jpg')); ?>" alt="Facility Image"></div>
                                <div class="swiper-slide"><img src="<?php echo e(asset('assets/img/project-2.jpg')); ?>" alt="Facility Image"></div>
                                <div class="swiper-slide"><img src="<?php echo e(asset('assets/img/project-3.jpg')); ?>" alt="Facility Image"></div>
                                <div class="swiper-slide"><img src="<?php echo e(asset('assets/img/project-4.jpg')); ?>" alt="Facility Image"></div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <!-- img -->
            <div class="col">
                <div class="ul-facilities-img"><img src="<?php echo e(asset('assets/img/facility-img.jpg')); ?>" alt="Facility Image"></div>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="ul-container">
        ...
        <div class="tabs-wrapper wow animate__fadeInUp">
            ...
            <div class="ul-tab" id="tab-buy">
                <div class="row row-cols-md-3 row-cols-2 row-cols-xxs-1 ul-bs-row">
                    <?php $__currentLoopData = $imoveisDestaque->reverse(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $imovel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col">
                        <div class="ul-project">
                            <div class="ul-project-img">
                                <?php if($imovel->capaFoto()): ?>
        ...
        <div class="text-center wow animate__fadeInUp">
            <a href="<?php echo e(route('imoveis.index')); ?>" class="ul-btn ul-properties-btn">Ver Mais Imóveis</a>
        </div>
    </div>
</section>
...
<div class="ul-stats ul-section-spacing">
    <div class="ul-stats-wrapper wow animate__fadeInUp">
        <div class="ul-stats-item">
            ...
            <span class="number"><?php echo e($estatisticas['imoveis'] ?? 0); ?>+</span>
            <span class="txt">Imóveis Anunciados</span>
        </div>
        <div class="ul-stats-item">
            <i class="flaticon-buildings"></i>
            <span class="number"><?php echo e($estatisticas['imobiliarias'] ?? 0); ?>+</span>
            <span class="txt">Empresas Anunciantes</span>
        </div>
        <div class="ul-stats-item">
            <i class="flaticon-home-tik-mark"></i>
            <span class="number"><?php echo e($estatisticas['interacoes'] ?? 0); ?>+</span>
            <span class="txt">Anúncios Verificados</span>
        </div>
        <div class="ul-stats-item">
            <i class="flaticon-map"></i>
            <span class="number"><?php echo e($estatisticas['provincias'] ?? 8); ?>+</span>
            <span class="txt">Províncias Cobertas</span>
        </div>
    </div>
</div>
        ...
        <div class="row row-cols-lg-2 row-cols-1 gx-0 align-items-center flex-lg-row flex-column-reverse gy-5">
            ...
            <div class="col">
                <div class="ul-testimonial-img wow animate__fadeInUp">
                    <img src="<?php echo e(asset('assets/img/testimonial-img.jpg')); ?>" alt="Testimonial Image">
                </div>
            </div>
                        ...
                        <div class="swiper-wrapper">
                                ...
                                <div class="ul-testimony">
                                    <div class="top">
                                        <div class="ul-testimony-reviewer-img">
                                            <img src="<?php echo e($depoimento->avatar ? asset('storage/' . $depoimento->avatar) : asset('assets/img/partner-1.png')); ?>" alt="Reviewer Image">
                                        </div>

                                        <div class="ul-testimony-reviewer-info">
                                            <h3 class="ul-testimony-reviewer-name"><?php echo e($depoimento->nome); ?></h3>
                                            <h4 class="ul-testimony-reviewer-role"><?php echo e($depoimento->cargo); ?></h4>
                                            <div class="ul-testimony-rating">
                                                <?php for($i = 1; $i <= 5; $i++): ?>
                                                <i class="flaticon-star" <?php echo e($i <= $depoimento->estrelas ? '' : 'style="opacity:0.25;"'); ?>></i>
                                                <?php endfor; ?>
                                            </div>
                                        </div>
                                    </div>
                                    <p class="ul-testimony-txt"><?php echo e($depoimento->texto); ?></p>
                                </div>
                            </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <?php else: ?>
                            ...
                            <div class="swiper-slide">
                                <div class="ul-testimony">
                                    <div class="top">
                                        <div class="ul-testimony-reviewer-img">
                                            <img src="<?php echo e(asset('assets/img/partner-1.png')); ?>" alt="Reviewer Image">
                                        </div>
                                        <div class="ul-testimony-reviewer-info">
    ...
    <div class="ul-container wow animate__fadeInUp">
        ...
        <div class="ul-partners-slider swiper">
            <div class="swiper-wrapper align-items-center">
                ...
                <?php else: ?>
                <!-- fallback -->
                <div class="swiper-slide"><img src="<?php echo e(asset('assets/img/partner-1.png')); ?>" alt="Parter Logo"></div>
                <div class="swiper-slide"><img src="<?php echo e(asset('assets/img/partner-2.png')); ?>" alt="Parter Logo"></div>
                <div class="swiper-slide"><img src="<?php echo e(asset('assets/img/partner-3.png')); ?>" alt="Parter Logo"></div>
                <div class="swiper-slide"><img src="<?php echo e(asset('assets/img/partner-4.png')); ?>" alt="Parter Logo"></div>
                <div class="swiper-slide"><img src="<?php echo e(asset('assets/img/partner-5.png')); ?>" alt="Parter Logo"></div>
                <div class="swiper-slide"><img src="<?php echo e(asset('assets/img/partner-6.png')); ?>" alt="Parter Logo"></div>
                <?php endif; ?>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.site', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\JORGE DANGE\Documents\PROGRAMACAO\WEB\QND\PageWeb\imobiliaria\qnb-imobiliaria\resources\views\welcome.blade.php ENDPATH**/ ?>