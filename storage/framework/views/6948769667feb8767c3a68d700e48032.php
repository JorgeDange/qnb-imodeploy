        ...
        <div style="padding: 30px;">
            ...
            <table style="width: 100%; border-collapse: collapse; margin: 20px 0;">
                ...
                <tr>
                    ...
                    <td style="padding: 10px; border-bottom: 1px solid #eee;"><?php echo e($pagamento->subscricao->data_expiracao ? $pagamento->subscricao->data_expiracao->format('d/m/Y') : '—'); ?></td>
                </tr>
                <?php if($pagamento->fatura): ?>
                <tr>
                    <td style="padding: 10px; border-bottom: 1px solid #eee; font-weight: bold; color: #555;">Fatura</td>
                    <td style="padding: 10px; border-bottom: 1px solid #eee;"><?php echo e($pagamento->fatura->numero); ?></td>
                </tr>
                <?php endif; ?>
            </table>
...
<?php /**PATH C:\Users\JORGE DANGE\Documents\PROGRAMACAO\WEB\QND\PageWeb\imobiliaria\qnb-imobiliaria\resources\views\emails\pagamento-confirmado.blade.php ENDPATH**/ ?>