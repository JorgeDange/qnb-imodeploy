        ...
        <div style="padding: 30px;">
            ...
            <table style="width: 100%; border-collapse: collapse; margin: 20px 0;">
                <tr>
                    ...
                    <td style="padding: 10px; border-bottom: 1px solid #eee;"><?php echo e($assinatura->plano->nome); ?></td>
                </tr>
                <tr>
                    <td style="padding: 10px; border-bottom: 1px solid #eee; font-weight: bold; color: #555;">Data de Início</td>
                    <td style="padding: 10px; border-bottom: 1px solid #eee;"><?php echo e($assinatura->data_inicio->format('d/m/Y')); ?></td>
                </tr>
                <tr>
                    <td style="padding: 10px; border-bottom: 1px solid #eee; font-weight: bold; color: #555;">Data de Expiração</td>
                    <td style="padding: 10px; border-bottom: 1px solid #eee;"><?php echo e($assinatura->data_expiracao ? $assinatura->data_expiracao->format('d/m/Y') : 'Indefinido'); ?></td>
                </tr>
                <tr>
                    <td style="padding: 10px; border-bottom: 1px solid #eee; font-weight: bold; color: #555;">Posts Disponíveis</td>
                    <td style="padding: 10px; border-bottom: 1px solid #eee;"><?php echo e($assinatura->plano->posts_limite - $assinatura->posts_usados); ?> de <?php echo e($assinatura->plano->posts_limite); ?></td>
                </tr>
            </table>
...
<?php /**PATH C:\Users\JORGE DANGE\Documents\PROGRAMACAO\WEB\QND\PageWeb\imobiliaria\qnb-imobiliaria\resources\views\emails\assinatura-liberada.blade.php ENDPATH**/ ?>