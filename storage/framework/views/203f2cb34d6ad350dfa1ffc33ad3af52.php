    ...
    <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 8px; overflow: hidden;">
        ...
        <div style="padding: 30px;">
            ...
            <div style="background: #f8d7da; border: 1px solid #e74c3c; border-radius: 6px; padding: 15px; margin: 20px 0;">
                <p style="margin: 0;"><strong>Imóvel:</strong> <?php echo e($visita->imovel->titulo ?? '—'); ?></p>
                <p style="margin: 5px 0 0 0;"><strong>Data pretendida:</strong> <?php echo e($visita->data_visita->format('d/m/Y H:i')); ?></p>
                <?php if($visita->observacoes): ?>
                <p style="margin: 5px 0 0 0;"><strong>Motivo:</strong> <?php echo e($visita->observacoes); ?></p>
                <?php endif; ?>
            </div>
            ...
            <div style="text-align: center; margin: 25px 0;">
                <a href="<?php echo e(route('home')); ?>" style="display:inline-block;background:#1a5276;color:#fff;padding:12px 30px;border-radius:6px;text-decoration:none;font-weight:bold;">Reagendar Visita</a>
            </div>
        </div>
...
<?php /**PATH C:\Users\JORGE DANGE\Documents\PROGRAMACAO\WEB\QND\PageWeb\imobiliaria\qnb-imobiliaria\resources\views\emails\visita-recusada.blade.php ENDPATH**/ ?>