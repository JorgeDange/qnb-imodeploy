    ...
    <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 8px; overflow: hidden;">
        ...
        <div style="padding: 30px;">
            ...
            <div style="background: #d4edda; border: 1px solid #27ae60; border-radius: 6px; padding: 15px; margin: 20px 0;">
                ...
                <p style="margin: 5px 0 0 0;"><strong>Data:</strong> <?php echo e($visita->data_visita->format('d/m/Y')); ?></p>
                <p style="margin: 5px 0 0 0;"><strong>Hora:</strong> <?php echo e($visita->data_visita->format('H:i')); ?></p>
            </div>

            <p>Por favor, chegue a tempo. Em caso de alteração, entre em contacto com a imobiliária.</p>

            <div style="text-align: center; margin: 25px 0;">
                <a href="<?php echo e(route('home')); ?>" style="display:inline-block;background:#1a5276;color:#fff;padding:12px 30px;border-radius:6px;text-decoration:none;font-weight:bold;">Ver Imóvel</a>
            </div>
        </div>
...
<?php /**PATH C:\Users\JORGE DANGE\Documents\PROGRAMACAO\WEB\QND\PageWeb\imobiliaria\qnb-imobiliaria\resources\views\emails\visita-confirmada.blade.php ENDPATH**/ ?>