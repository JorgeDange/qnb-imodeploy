<?php $__env->startSection('title', 'Pagamento Submetido — Painel | QNB-Imobiliária'); ?>
...
<div class="ul-painel-card" style="text-align:center;padding:40px 20px;">
    ...
    <div style="margin-top:25px;">
        <a href="<?php echo e(route('painel.pagamentos')); ?>" class="ul-btn"><i class="bi bi-list-ul"></i> Ver Pagamentos</a>
        <a href="<?php echo e(route('painel.dashboard')); ?>" class="ul-btn" style="margin-left:10px;"><i class="bi bi-house"></i> Dashboard</a>
    </div>
</div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.painel', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\JORGE DANGE\Documents\PROGRAMACAO\WEB\QND\PageWeb\imobiliaria\qnb-imobiliaria\resources\views\painel\pagamento\confirmado.blade.php ENDPATH**/ ?>