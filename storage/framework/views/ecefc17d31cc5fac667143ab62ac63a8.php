        ...
        <div style="padding: 30px;">
            ...
            <table style="width: 100%; border-collapse: collapse; margin: 20px 0;">
                <tr>
                    ...
                    <td style="padding: 10px; border-bottom: 1px solid #eee;"><?php echo e($mensagem->nome); ?></td>
                </tr>
                <tr>
                    <td style="padding: 10px; border-bottom: 1px solid #eee; font-weight: bold; color: #555;">Contacto</td>
                    <td style="padding: 10px; border-bottom: 1px solid #eee;"><?php echo e($mensagem->contacto); ?></td>
                </tr>
                <tr>
                    <td style="padding: 10px; border-bottom: 1px solid #eee; font-weight: bold; color: #555;">Imóvel</td>
                    <td style="padding: 10px; border-bottom: 1px solid #eee;"><?php echo e($mensagem->imovel->titulo ?? '—'); ?></td>
                </tr>
                <tr>
                    <td style="padding: 10px; border-bottom: 1px solid #eee; font-weight: bold; color: #555;">Origem</td>
                    <td style="padding: 10px; border-bottom: 1px solid #eee;"><?php echo e(ucfirst($mensagem->origem)); ?></td>
                </tr>
            </table>
            ...
            <div style="background-color: #f9f9f9; border-left: 4px solid #1a5276; padding: 15px; margin: 20px 0;">
                ...
                <p style="margin: 10px 0 0 0; color: #333;"><?php echo e($mensagem->texto); ?></p>
            </div>
