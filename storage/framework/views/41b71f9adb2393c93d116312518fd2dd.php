...
<body style="font-family: Arial, sans-serif; background-color: #f4f4f4; margin: 0; padding: 20px;">
    <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 8px; overflow: hidden;">
        ...
        <div style="padding: 30px;">
            ...
            <p>A imobiliária <strong><?php echo e($pagamento->imobiliaria->nome); ?></strong> submeteu um novo pagamento para validação.</p>

            <table style="width: 100%; border-collapse: collapse; margin: 20px 0;">
                <tr>
                    <td style="padding: 10px; border-bottom: 1px solid #eee; font-weight: bold; color: #555;">Imobiliária</td>
                    <td style="padding: 10px; border-bottom: 1px solid #eee;"><?php echo e($pagamento->imobiliaria->nome); ?></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td style="padding: 10px; border-bottom: 1px solid #eee;"><?php echo e(ucfirst($pagamento->metodo)); ?></td>
                </tr>
                <tr>
                    <td style="padding: 10px; border-bottom: 1px solid #eee; font-weight: bold; color: #555;">Referência</td>
                    <td style="padding: 10px; border-bottom: 1px solid #eee;"><?php echo e($pagamento->referencia ?? '—'); ?></td>
                </tr>
                <tr>
                    <td style="padding: 10px; border-bottom: 1px solid #eee; font-weight: bold; color: #555;">Data</td>
                    <td style="padding: 10px; border-bottom: 1px solid #eee;"><?php echo e($pagamento->created_at->format('d/m/Y H:i')); ?></td>
                </tr>
            </table>
...
<?php /**PATH C:\Users\JORGE DANGE\Documents\PROGRAMACAO\WEB\QND\PageWeb\imobiliaria\qnb-imobiliaria\resources\views\emails\pagamento-recebido.blade.php ENDPATH**/ ?>